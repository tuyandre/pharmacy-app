        ...
        <div class="row">
            <div class="col-lg-12  order-1 order-lg-2 mb-5 mb-lg-0">
                <div class="alert alert-success  alert-dismissible fade show" role="alert">
                    ...
                    <p class="lead text-center"><b>Your search of {{ $name}} located at location like {{ $location }} matches {{ $filteredmedecines->count() }} medicines</b></p>
                    @else
                    <p class="lead text-center"><b>Your search of {{ $name }} located at location like {{ $location }} matches only {{ $filteredmedecines->count() }} medicine</b></p>
                    @endif
